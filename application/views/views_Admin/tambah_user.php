                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="<?php echo site_url('c_admin/upload_foto_user/');?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6 col-xs-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form method="post" action="<?php echo site_url('c_admin/add_user/') ?>">
                                    <div class="form-group">
