                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo site_url('c_admin/show_all_user') ?>">Tampil Data User</a></li>
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="<?php echo site_url('c_admin/upload_foto_user/' .$data_user->id);?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6 col-xs-6 ">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form method="post" action="<?php echo site_url('c_admin/edit_user/' .$data_user->id) ?>">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Fullname</label>
                                        <input type="text" class="form-control" name="fullname" placeholder="Fullname" value="<?php echo $data_user->fullname ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Username</label>
                                        <input type="text" class="form-control" name="username" placeholder="Username" value="<?php echo $data_user->username ?>" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email address</label>
                                        <input type="email" class="form-control" name="email" aria-describedby="emailHelp" placeholder="Enter email" value="<?php echo $data_user->email ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Password</label>
                                        <input type="password" class="form-control" name="password" placeholder="Password Baru" value="<?php echo $data_user->password ?>">
                                    </div>
                                    <button type="submit" class="btn btn-danger">Submit</button>
                                </form>
