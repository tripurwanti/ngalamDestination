            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">Tampil Data Admin</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <tbody>
                            <?php foreach ($data_all_admin as $key) { ?>
                            <tr>
                                <td><a><?php echo $key->fullname; ?></a></td>
                                <td><?php echo $key->username; ?></td>
                                <td style="text-align: center;">
                                    <a href="<?php echo site_url('c_admin/delete_admin/' .$key->id) ?>">Delete</a>
                                </td>
                            </tr>
                            <?php } ?>                            
                        </tbody>
